...
RSpec.describe User do
  ...
  describe 'password shouldnt be too short' do
    #password should not be less than 6 symbols
  ...
  describe 'return value of authenticate method' do
    ...
    describe 'with invalid password' do
      let(:user_for_invalid_password) { found_user.authenticate('password') }
  ...
  describe 'when email should be invalid' do
  ...
  describe 'when email format should be valid' do
    it 'should be valid' do
      addresses = %w[user@foo.COM A_US-ER@f.b.org frst.lst@foo.jp a+baz@baz.cn]
